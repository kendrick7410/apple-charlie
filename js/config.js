...
// ── Lieux à découvrir : de petites scènes qui remplissent l'espace vide de la carte ──
// Chaque lieu : { x, y, label, items:[[emoji, dx, dy, tailleRem], ...], bg?:{w,h,dx,dy,color} }
Game.LANDMARKS = [
    { x: 4600, y: 750, label: "🍎 Le Verger", items: [
        ["🌳",-70,-30,3.4],["🍎",-64,-8,1.2],["🌳",-5,-45,3.6],["🍎",2,-22,1.2],
        ["🌳",60,-30,3.4],["🍎",66,-8,1.2],["🌳",-35,25,3],["🌳",40,28,3],["🧺",0,35,1.8] ] },

    { x: 5300, y: 1450, label: "🌻 Champ de Tournesols", items: [
        ["🌻",-70,-20,2.4],["🌻",-30,-40,2.6],["🌻",10,-15,2.4],["🌻",55,-38,2.6],
        ["🌻",-50,20,2.2],["🌻",30,22,2.4],["🌻",75,5,2.2],["🐝",0,-30,1.2] ] },

    { x: 4950, y: 2450, label: "🌳 Le Grand Chêne", items: [
        ["🌳",0,-20,6.5],["🐿️",-45,35,1.6],["🍄",40,45,1.4],["🌿",-60,50,1.4] ] },

    { x: 5400, y: 3150, label: "🌲 Bois de Bouleaux", items: [
        ["🌲",-60,-20,3.6],["🌲",-15,-40,3.8],["🌲",35,-15,3.6],["🌲",70,-35,3.4],
        ["🌲",-40,25,3.2],["🌲",25,28,3.2],["🍄",0,45,1.3] ] },

    { x: 4400, y: 3450, label: "🚜 La Petite Ferme", items: [
        ["🏡",0,-35,3.4],["🚜",-60,15,2.2],["🐄",50,12,2.2],["🐔",70,35,1.4],
        ["🐖",-5,35,1.6],["🌾",-70,38,1.6],["🐑",30,38,1.6] ] },

    { x: 3700, y: 4300, label: "🗿 Cercle de Pierres", items: [
        ["🗿",0,-45,2.8],["🪨",-55,-15,2.2],["🪨",55,-15,2.2],["🪨",-40,35,2.2],
        ["🪨",40,35,2.2],["✨",0,-5,1.6] ] },

    { x: 4300, y: 4600, label: "🎃 Le Potager Sauvage", items: [
        ["🎃",-55,0,2.2],["🎃",5,-20,2.4],["🎃",55,5,2.2],["🌽",-25,25,2],
        ["🍅",30,28,1.6],["🌿",-60,-25,1.6] ] },

    { x: 5300, y: 4500, label: "🌹 La Roseraie", items: [
        ["🌹",-55,-10,2],["🌷",-20,-30,2],["🌸",15,-8,2],["🌹",50,-28,2],
        ["🌷",-35,25,1.8],["🌸",35,25,1.8],["🦋",0,-25,1.4] ] },

    { x: 5000, y: 3900, label: "🐝 Le Rucher", items: [
        ["🪵",0,-15,2.6],["🍯",-45,20,1.8],["🐝",45,-30,1.3],["🐝",-30,-35,1.1],
        ["🐝",20,10,1.1],["🌼",55,25,1.6] ] },

    { x: 1200, y: 2600, label: "⛺ Le Campement", items: [
        ["⛺",0,-25,3.6],["🔥",55,20,2.2],["🪵",30,40,1.8],["🪵",70,40,1.6],
        ["🎒",-55,25,1.8],["🌲",-70,-30,3] ] },

    { x: 1800, y: 3200, label: "🦆 L'Étang", bg: { w: 220, h: 130, dx: -110, dy: -55, color: "#7ec8f0" }, items: [
        ["🦆",-30,-20,2],["🦢",40,-10,2],["🪷",-55,20,1.6],["🐸",55,25,1.6],
        ["🌾",-80,-25,1.8],["🌾",75,-30,1.8] ] },

    { x: 950, y: 4200, label: "🐰 La Colline aux Lapins", items: [
        ["🐰",-40,-10,2],["🐇",25,-25,2],["🐰",55,10,1.8],["🥕",-15,25,1.4],
        ["🥕",40,30,1.4],["🌱",-55,25,1.4] ] },

    { x: 2300, y: 4450, label: "🎃 Le Champ de Citrouilles", items: [
        ["🎃",-60,0,2.4],["🎃",-15,-22,2.6],["🎃",35,5,2.4],["🎃",70,-18,2.2],
        ["🍂",0,30,1.6],["🌿",-40,28,1.5] ] },

    { x: 3450, y: 2650, label: "💦 La Source", bg: { w: 150, h: 110, dx: -75, dy: -30, color: "#8fd4f0" }, items: [
        ["🪨",-45,-40,2.6],["🪨",45,-38,2.4],["💧",0,-30,1.6],["🌿",-55,20,1.6],
        ["🌿",55,22,1.6],["🐟",10,10,1.2] ] },

    { x: 2650, y: 2300, label: "🧺 Aire de Pique-nique", items: [
        ["🧺",0,-10,2.4],["🍉",-45,15,1.6],["🥪",40,18,1.5],["🌳",-70,-30,3.2],
        ["🌳",65,-28,3.2],["🦋",15,-30,1.3] ] },

    { x: 4300, y: 2000, label: "🍒 Verger de Cerisiers", items: [
        ["🌸",-60,-25,3.2],["🍒",-55,-4,1.3],["🌸",0,-40,3.4],["🍒",6,-18,1.3],
        ["🌸",60,-25,3.2],["🌳",-30,25,2.8],["🌳",35,28,2.8] ] },

    { x: 900, y: 3300, label: "🍄 Le Coin aux Champignons", items: [
        ["🍄",-40,-5,2],["🍄",20,-22,2.2],["🍄",50,8,1.8],["🌲",-65,-30,3],
        ["🌲",60,-32,3],["🐛",0,25,1.2] ] },

    { x: 5450, y: 2350, label: "🪨 Les Grands Rochers", items: [
        ["🪨",-40,-20,3.4],["🪨",35,-10,3.8],["🪨",5,25,2.8],["🌿",-55,25,1.6],
        ["🦎",45,20,1.3] ] }
];
